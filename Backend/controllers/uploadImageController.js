...
export const uploadMobileBannerController = async (req,res)=>{
...
export const getMObileBannerController = async (req, res) => {
  try {
    const banner = await BannerModel.findOne()
